...
import NewAfterLamax3 from './Screen/NewAfterLamax3';
    ...
    <Provider store={store}>
      <BrowserRouter>
        <Switch>
          ...
          <Route exact path="/casesummary" component={CaseSummaryRedux} />
          ...
          <Route exact path="/newAfterLamax3" component={NewAfterLamax3} />
